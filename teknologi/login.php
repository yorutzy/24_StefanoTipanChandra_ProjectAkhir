...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM web_teknologi WHERE username='$username'";
...
.social-circle svg {
  ...
  background: linear-gradient(135deg, rgba(0,180,219,0.40), rgba(0,131,176,0.40));
    ...
    <div class="main-content">
        <div class="container">
            <form method="POST" action="">
                ...
                <fieldset>
                    <legend style="color: #0098f0ff;">Login Form</legend>

                    <div class="form-row">
                        <label for="username" style="color: #00ffd5ff;">Username</label>
                        <span class="colon">:</span>
                        <input type="text" name="username" placeholder="Enter your username" required>
                    </div>

                    <div class="form-row">
                        <label for="password" style="color: #00ffd5ff;">Password</label>
                        <span class="colon">:</span>
            ...
            <p class="redirect">
                Don't have account yet? <a href="register.php">Register here</a>
            </p>
